...
description: Analyze HTML pages and generate Chrome extension code (Manifest V3) for content injection, DOM manipulation, network interception, and functionality enhancement. Use when building Chrome extensions to (1) Extract data from web pages, (2) Modify page content and styling, (3) Monitor page changes and events, (4) Intercept and modify network requests, (5) Add new UI elements and functionality. Handles SPAs, shadow DOM, dynamic content, and provides robust selector strategies.
---

# Chrome Extension Analyzer

Comprehensive toolkit for analyzing web pages and creating robust Chrome extensions (Manifest V3) that inject functionality, extract data, and modify page behavior.
